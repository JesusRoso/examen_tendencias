...
class menu_VI
{
    ...
    function verMenu()
    {
        ...
        $arreglo=$estudiantes_MO->seleccionar($_SESSION['estu_id']);

        $objeto_estudiantes=$arreglo[0];
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <span class="brand-text font-weight-light">Examen Final</span>
            </a>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                <a href="#" class="d-block"><?php echo ucwords(strtolower($estu_nombres)).' '.ucwords(strtolower($estu_apellidos));?></a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="#" onclick="verMenu('estudiantes_VI/agregar')" class="nav-link">
                        <i class="fas fa-graduation-cap"></i>
                        <p>Estudiantes</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" onclick="verMenu('asignaturas_VI/agregar')" class="nav-link">
                        <i class="fas fa-book" style="margin-right: 5px;"></i>
                        <p>Asignaturas</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" onclick="verMenu('tipo_notas_VI/agregar')" class="nav-link">
                        <i class="fas fa-clipboard" style="margin-right: 5px;"></i>
                        <p>Tipo de notas</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" onclick="verMenu('estudiantes_asignaturas_VI/agregar')" class="nav-link">
